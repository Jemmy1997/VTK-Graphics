...
class AppWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.mode_select.currentTextChanged.connect(self.combo)

        self.vtkwid1 = QVTKRenderWindowInteractor(self.ui.frame1_viewer)
        ...
        self.vtkwid2 = QVTKRenderWindowInteractor(self.ui.frame2_viewer)
    ...
    def iso_valu(self):
        ...
        if self.ui.mode_select.currentText() == 'Surface Rendering':
            self.surfaceExtractor.SetValue(0, self.ui.iso.value())
            self.vtkwid1.update()

    def combo(self, value):
        if value == 'Surface Rendering':

            self.surfaceExtractor.SetInputConnection(
        ...
        if value == 'Ray Casting Rendering':
